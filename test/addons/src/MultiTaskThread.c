...
void MultiTaskThread_2_thread_10_entity() {
    ...
    ecs_set_task_threads(world, THREADS, ecs_os_api.thread_new_, ecs_os_api.thread_join_);
...
void MultiTaskThread_change_thread_count() {
    ...
    ecs_set_task_threads(world, 2, ecs_os_api.thread_new_, ecs_os_api.thread_join_);
    ...
    ecs_set_task_threads(world, 3, ecs_os_api.thread_new_, ecs_os_api.thread_join_);
...
void MultiTaskThread_no_staging_w_multithread() {
    for (int i = 0; i < 10; i ++) {
        ...
        ecs_set_task_threads(world, 32, ecs_os_api.thread_new_, ecs_os_api.thread_join_);
...
void MultiTaskThread_multithread_w_monitor_addon() {
    ...
    ecs_set_task_threads(world, 4, ecs_os_api.thread_new_, ecs_os_api.thread_join_);
    ecs_progress(world, 0);
    ecs_fini(world);
...
void MultiTaskThread_bulk_new_in_no_readonly_w_multithread() {
    ...
    ecs_set_task_threads(world, 80, ecs_os_api.thread_new_, ecs_os_api.thread_join_);
...
void MultiTaskThread_bulk_new_in_no_readonly_w_multithread_2() {
    ...
    ecs_set_task_threads(world, 64, ecs_os_api.thread_new_, ecs_os_api.thread_join_);
